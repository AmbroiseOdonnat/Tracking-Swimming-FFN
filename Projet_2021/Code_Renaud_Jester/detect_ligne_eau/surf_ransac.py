# code from https://docs.opencv.org/3.4/d7/dff/tutorial_feature_homography.html
...
if __name__ == "__main__":
    ...
    parser.add_argument('--input1', help='Path to input image 1 which is the object.', default='./media/box.png')
    parser.add_argument('--input2', help='Path to input image 2 which is the scene.', default='./media/box_in_scene.png')
    ...
    dst = cv.warpPerspective(img_scene, H, (img_object.shape[0], img_object.shape[1]))
    cv.namedWindow('apply homography', cv.WINDOW_NORMAL)
    cv.imshow('apply homography', dst)
    cv.waitKey(0)
